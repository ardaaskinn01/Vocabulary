                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          buildCategorySection(
                            [
                              buildCategoryCard(context, "Economics", "economics", isLocked: !isPremium),
                              buildCategoryCard(context, "Economics II", "economics2", isLocked: !isPremium),
                              buildCategoryCard(context, "History", "history", isLocked: !isPremium),
                              buildCategoryCard(context, "History II", "history 2", isLocked: !isPremium),
                              buildCategoryCard(context, "Technology", "technology", isLocked: !isPremium),
                              buildCategoryCard(context, "Technology II", "technology2", isLocked: !isPremium),
                              buildCategoryCard(context, "Health", "health", isLocked: !isPremium),
                              buildCategoryCard(context, "Health II", "health2", isLocked: !isPremium),
                              buildCategoryCard(context, "Biology", "biology", isLocked: !isPremium),
                              buildCategoryCard(context, "Biology II", "biology2", isLocked: !isPremium),
                              buildCategoryCard(context, "Politics", "politics", isLocked: !isPremium),
                              buildCategoryCard(context, "Politics II", "politics2", isLocked: !isPremium),
                            ],
                            [
                              ...
                              buildCategoryCard(context, "Common Mistakes", "commonmistakes", isLocked: !isPremium),
                            ],
                          ),
                        ],
                      ),
